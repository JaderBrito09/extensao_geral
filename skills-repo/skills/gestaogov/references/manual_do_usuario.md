# MANUAL DO USUÁRIO – SISTEMA GESTAOPUBLICAGOV.BR
...
O sistema do Modelo de Governança e Gestão Pública, o Sistema Gestaopublicagov.br, reúne as funcionalidades para a aplicação de Instrumento de Maturidade de Governança e Gestão (IMGG),possibilitando a avaliação e a melhoria das práticas e dos resultados de governança e gestão, a implementação de planos de melhoria da gestão e a certificação do Nível de Maturidade de Governança e Gestão, a partir da implementação do Modelo.

## 2. OBJETIVO

Este documento fornece orientações sobre as principais telas e funcionalidades do sistema para os perfis:
* Presidente do Comitê de Aplicação;
* Membro do Comitê de Aplicação;
* Coordenador de Rede de Parcerias Federal;
* Coordenador de Rede de Parcerias Estadual; e
...
![Figura 2 – Credenciais de Acesso (CPF)](./images/manual_p5_3_Image91.jpg)  
*(Figura 2 – Credenciais de Acesso (CPF))*

![Figura 3 – Credenciais de acesso (senha)](./images/manual_p5_4_Image92.jpg)  
*(Figura 3 – Credenciais de acesso (senha))*
...
![Figura 7 – Tela Termo de Adesão](./images/manual_p7_8_Image98.png)  
*(Figura 7 – Tela Termo de Adesão)*
...
![Figura 9 – Membro do Comitê de Aplicação](./images/manual_p9_10_Image102.png)  
*(Figura 9 – Membro do Comitê de Aplicação)*
...
![Figura 14 – Tela inicial de Aplicação de IMGG](./images/manual_p11_16_Image110.png)  
*(Figura 14 – Tela inicial de Aplicação de IMGG)*
...
* Coordenador da Rede de Parcerias Municipal: Aplicação, FAQ e Glossário (Figura 20).
...
![Figura 16 – Presidente do Comitê de Aplicação](./images/manual_p13_21_Image117.png)  
*(Figura 16 – Presidente do Comitê de Aplicação)*

![Figura 17 – Membro do Comitê de Aplicação](./images/manual_p13_22_Image118.png)  
*(Figura 17 – Membro do Comitê de Aplicação)*

![Figura 18 – Coordenador da Rede de Parcerias Federal](./images/manual_p14_23_Image120.png)  
*(Figura 18 – Coordenador da Rede de Parcerias Federal)*
...
![Figura 24 – Presidente Comitê de Aplicação](./images/manual_p17_29_Image130.png)  
...
![Figura 28 – Membro do Comitê de Aplicação](./images/manual_p20_34_Image139.png)  
*(Figura 28 – Membro do Comitê de Aplicação)*

![Figura 29 – Coordenador da Rede de Parcerias Federal](./images/manual_p20_35_Image140.png)  
*(Figura 29 – Coordenador da Rede de Parcerias Federal)*
...
![Figura 31 – Coordenador da Rede de Parcerias Municipal](./images/manual_p21_37_Image143.png)  
*(Figura 31 – Coordenador da Rede de Parcerias Municipal)*

![Figura 32 – Presidente do Comitê de Aplicação](./images/manual_p22_38_Image145.png)  
*(Figura 32 – Presidente do Comitê de Aplicação)*

![Figura 33 – Membro do Comitê de Aplicação](./images/manual_p22_39_Image146.png)  
*(Figura 33 – Membro do Comitê de Aplicação)*

![Figura 34 – Coordenador Rede de Parcerias Federal](./images/manual_p23_40_Image148.png)  
*(Figura 34 – Coordenador Rede de Parcerias Federal)*

![Figura 35 – Coordenador Rede de Parcerias Estadual](./images/manual_p23_41_Image149.png)  
*(Figura 35 – Coordenador Rede de Parcerias Estadual)*
...
![Figura 37 – Presidente do Comitê de Aplicação](./images/manual_p25_47_Image157.png)  
*(Figura 37 – Presidente do Comitê de Aplicação)*

![Figura 38 – Coordenadores da Rede de Parcerias Federal](./images/manual_p25_48_Image158.png)  
*(Figura 38 – Coordenadores da Rede de Parcerias Federal)*
...
![Figura 42 – Tela de Cadastro da Organização (Competências Regimentais/Missão)](./images/manual_p28_52_Image168.png)  
*(Figura 42 – Tela de Cadastro da Organização (Competências Regimentais/Missão))*

![Figura 43 – Tela de Cadastro da Organização (Produtos/Serviços e Usuários)](./images/manual_p28_53_Image169.png)  
*(Figura 43 – Tela de Cadastro da Organização (Produtos/Serviços e Usuários))*

![Figura 44 – Tela de Cadastro da Organização (Comitê de Aplicação)](./images/manual_p29_54_Image172.png)  
*(Figura 44 – Tela de Cadastro da Organização (Comitê de Aplicação))*

![Figura 45 – Tela de Cadastro da Organização (Arquivos e Evidências da Aplicação)](./images/manual_p29_55_Image173.png)  
*(Figura 45 – Tela de Cadastro da Organização (Arquivos e Evidências da Aplicação))*

![Figura 46 – Tela de Avaliação (exibição das alíneas do Critério Governança)](./images/manual_p30_56_Image176.png)  
*(Figura 46 – Tela de Avaliação (exibição das alíneas do Critério Governança))*

![Figura 47 – Tela de Avaliação – Fatores de Avaliação (requisitos 1 e 2 - alínea a – Critério 1)](./images/manual_p30_57_Image177.png)  
*(Figura 47 – Tela de Avaliação – Fatores de Avaliação (requisitos 1 e 2 - alínea a – Critério 1))*

![Figura 48 – Tela Plano de Melhoria de Governança e Gestão (PMGG)](./images/manual_p31_58_Image180.png)  
*(Figura 48 – Tela Plano de Melhoria de Governança e Gestão (PMGG))*

![Figura 49 – Tela de Requisitos (cadastro de requisitos para certificação)](./images/manual_p31_59_Image181.png)  
*(Figura 49 – Tela de Requisitos (cadastro de requisitos para certificação))*

![Figura 50 – Tela de Práticas Destacadas (cadastro Práticas Destacadas)](./images/manual_p32_60_Image184.png)  
*(Figura 50 – Tela de Práticas Destacadas (cadastro Práticas Destacadas))*

![Figura 51 – Tela Relatório Preliminar](./images/manual_p32_61_Image185.png)  
*(Figura 51 – Tela Relatório Preliminar)*
