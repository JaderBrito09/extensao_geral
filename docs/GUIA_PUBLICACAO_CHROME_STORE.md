...
## 📋 Pré-requisitos
1. **Arquivo `.zip` de Produção**: [`assistente-jorge-extension-v7.zip`](file:///Users/jader/Meu%20Drive/extensao_geral/assistente-jorge-extension-v7.zip) gerado na raiz do projeto.
...
2. Arraste ou selecione o arquivo `assistente-jorge-extension-v7.zip`.
