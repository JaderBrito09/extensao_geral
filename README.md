...
```bash
zip -r assistente-jorge-extension-v1.2.4.zip manifest.json background.js content.js popup.html popup.css popup.js sidepanel.html sidepanel.css sidepanel.js icons/ lib/ -x "*.DS_Store"
```
O pacote compilado é gerado como `assistente-jorge-extension-v1.2.4.zip` na raiz do projeto.
