...
```bash
zip -r assistente-jorge-extension-v1.2.3.zip manifest.json sidepanel.html sidepanel.js sidepanel.css background.js icons/ lib/ -x "*.DS_Store"
```
O pacote compilado é gerado como `assistente-jorge-extension-v1.2.3.zip` na raiz do projeto.
